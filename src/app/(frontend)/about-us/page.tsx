      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-5 gap-8 items-stretch">
            {/* Strategy 1 */}
            <AnimatedCard className="md:col-span-3 transition-all duration-300 hover:scale-[1.02] hover:border-[#008080]/30 border border-transparent h-[400px]">
              <CardHeader className="h-auto">
                <CardTitle className="text-2xl text-[#008080] flex items-center gap-3">
                  全球化资源整合
                </CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col h-[calc(400px-var(--card-header-height))]">
            ...
            <div className="md:col-span-2 relative w-full h-[400px] overflow-hidden rounded-lg">
              <Image
                src="/resource-integration.jpg"
                alt="Resource Integration"
                fill
            ...
            {/* Strategy 2 - Make it full width */}
            <div className="md:col-span-5 flex flex-col md:grid md:grid-cols-3 gap-8">
