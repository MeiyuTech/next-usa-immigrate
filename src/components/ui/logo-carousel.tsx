    ...
    () => [
      {
        name: 'AE',
        id: 1,
        img: '/press/ae-logo-vector-1024x281.png',
        alt: 'AE Logo',
      },
      {
        name: 'Copy Beat Musso',
        id: 2,
        img: '/press/copy-beat_musso_final1.jpg',
        alt: 'Copy Beat Musso Logo',
      },
      {
        name: 'Fabulous Cali',
        id: 3,
        img: '/press/cropped-fabulous-cali-logo.webp',
        alt: 'Fabulous Cali Logo',
      },
      {
        name: 'Cuisine Travel',
        id: 4,
        img: '/press/cuisine-travel.webp',
        alt: 'Cuisine Travel Logo',
      },
      {
        name: 'Daily Pilot Times OC',
        id: 5,
        img: '/press/daily-pilot-times-oc-logo.webp',
        alt: 'Daily Pilot Times OC Logo',
      },
      {
        name: 'Daily Pilot',
        id: 6,
        img: '/press/dailypilotlogo-1024x210.webp',
        alt: 'Daily Pilot Logo',
      },
      {
        name: 'Fox 11',
        id: 7,
        img: '/press/fox-11.png',
        alt: 'Fox 11 Logo',
      },
      {
        name: 'Gayot',
        id: 8,
        img: '/press/gayot-logo.webp',
        alt: 'Gayot Logo',
      },
      {
        name: 'KTLA',
      ...
      },
      {
        name: 'Local Magazine',
        id: 10,
        img: '/press/localelogo_maghub_178x48_300di.webp',
        alt: 'Local Magazine Logo',
      },
      {
        name: 'GOC',
        id: 11,
        img: '/press/logo-goc-large.webp',
        alt: 'GOC Logo',
      },
      {
        name: 'Patch',
        id: 12,
        img: '/press/logo-patch-800x600-1.webp',
        alt: 'Patch Logo',
      },
      {
        name: 'MHW',
      ...
      },
      {
        name: 'Res Hos',
        id: 14,
        img: '/press/res-hos.webp',
        alt: 'Res Hos Logo',
      },
      {
        name: 'Riviera',
        id: 15,
        img: '/press/riviera.webp',
        alt: 'Riviera Logo',
      },
      {
        name: 'Style Society',
        id: 16,
        img: '/press/stylesocietysized-300x122-1.webp',
        alt: 'Style Society Logo',
      },
    ],
    []
  )
